...
class HomeTests(TestCase):
    def setUp(self):
        self.board = Board.objects.create(name='Django', description='Django bulletin board')
        url = reverse('home')
    ...
    def test_home_view_contains_links_to_status_page(self):
...
class BoardTopicTests(TestCase):
    ...
    def test_board_topics_view_contains_navigation_links(self):
        ...
        newtopic_url = reverse('new_topic', kwargs={'pk': 1})
...
class NewTopicTests(TestCase):
    ...
    def test_new_topic_view_contains_link_to_board_topic(self):
    ...
    def test_new_topic_valid_post_data(self):
        ...
        data = {
            'subject': 'Test title',
            'message': 'Test message with lots of text'
        }
